...
export default function ImageCard(prop: any) {
  return (
    <>
      <div>
        <div className="h-[350px] w-[350px] md:h-[300px] md:w-[300px] md:overflow-hidden md:bg-cover md:bg-no-repeat">
          <Image
            src={prop.image}
            alt="shoes image"
            height={1440}
            width={1440}
            className="md:h-[300px] md:w-[300px] md:transition md:duration-300 md:ease-in-out md:hover:scale-110"
          />
        </div>
